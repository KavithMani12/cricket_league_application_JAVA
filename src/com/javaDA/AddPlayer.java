...
public class AddPlayer extends JFrame implements ActionListener{
    ...
    public AddPlayer(){
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[] { "school"
                , "Collage", "seniorGrade", "stateLevel", "None" }));
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(138, 43, 226), 2), "Add Player", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            if(e.getSource()==b1){
                ...
                String sql = "INSERT INTO players(player_id,name,department,regno,lastMatch,hostelBloack,roomNo) VALUES (?,?,?,?,?,?,?)";
