...
public class statistics extends JFrame{
    ...
    public void auctionPlayers(){
        try{
            conn con = new conn();
            String sql = "select * from AuctionPlayer";
    ...
    public void scheduleMatches(){
        try{
            conn con = new conn();
            String sql = "select * from Matches_played";
            PreparedStatement st = con.c.prepareStatement(sql);
            ResultSet rs = st.executeQuery();
    ...
    public statistics(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Players-playing",
        ...
        panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Matches-played-details",
