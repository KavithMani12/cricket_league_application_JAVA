...
public class ScheduleMatch extends JFrame implements ActionListener{
    ...
    public ScheduleMatch(){
        ...
        comboBox.setModel(new DefaultComboBoxModel(new String[] { "v1", "v2", "v3", "v4", "v5"}));
        comboBox.setBounds(173, 186, 194, 20);
        contentPane.add(comboBox);

        b1 = new JButton("add match");
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(138, 43, 226), 2), "Matches", TitledBorder.LEADING,
    ...
    public void actionPerformed(ActionEvent e) {
        try{
            conn con = new conn();
            if(e.getSource()==b1){
                String sql ="INSERT INTO Matches_played(match_win,match_id,team1,team2,venue,score1,score2) VALUES (?,?,?,?,?,?,?)";
...
//                System.out.println(t6.getText());
                ...
                if(rs>0)
                    JOptionPane.showMessageDialog(null, "Successfully Added match");
                else
